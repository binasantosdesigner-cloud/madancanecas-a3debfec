...
export function Footer() {
  ...
  return (
    <footer className="mt-24 border-t-2 border-accent/30 bg-secondary/40">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              title="(66) 98426-6994"
              className="group relative flex items-center justify-center size-9 rounded-full bg-accent/10 text-accent hover:bg-accent hover:text-white transition-colors"
            >
              ...
              <span className="pointer-events-none absolute -top-9 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-foreground px-2 py-1 text-xs text-background opacity-0 group-hover:opacity-100 transition-opacity">
                (66) 98426-6994
              </span>
            </a>
      ...
      <div className="border-t border-border/60 py-6 flex flex-col sm:flex-row items-center justify-between gap-2 px-6 max-w-7xl mx-auto text-[11px] uppercase tracking-[0.15em] text-muted-foreground">
        ...
        >
          Desenvolvido por <span className="font-semibold text-accent">Box Criativa</span>
        </a>
      </div>
    </footer>
  );
